...
<meta charset="utf-8"/>
  ...
  @media screen and (max-width: 450px) {
    ...
    .background-image {
      ...
      background-image: url(https://static.hori-uchi.com/2017/01/01151618/2016-11-11-10.34.21.jpg) !important;
    }
  ...
  <body class="background error-page-wrapper background-color background-image">
	...
	<div class="content-container shadow">
		<div class="head-line secondary-text-color">
			メンテナンス中<br />Maintenance
		</div>
		<div class="subheader primary-text-color">
		  只今メンテナンスを行っています。
			<br />We're undergoing a bit of
    ...
    <p>ご不便おかけしてすみません。 できるだけ早く再開いたしますので、今しばらくお待ち下さい。<br />Sorry for the inconvenience. We'll be back up and running as fast as possible.</p>
